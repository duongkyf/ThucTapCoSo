      ...
      <div className="confirm-dialog-body">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px 20px' }}>
          {[
            ...
            { label: 'Số hành khách', value: `${booking.total_passengers || booking.passenger_count || 1} người` },
  ...
  return (
    <div className="panel-card">
      ...
      <AdminTable loading={loading} headers={HEADERS}
        rows={filtered.map((x) => {
          const passengerCount = x.total_passengers || x.passenger_count || 1;
          return (
            <tr key={x.booking_id} className={x.status === 'Chờ hủy' ? 'row-highlight-warning' : ''}>
              ...
              <td>
                <div>
                  ...
                  {passengerCount > 1 && (
                    <span style={{ fontSize: 11, color: '#94a3b8', marginLeft: 6 }}>+{passengerCount - 1} người</span>
                  )}
                </div>
              ...
              <td className="text-blue">
                <strong>{Number(x.total_amount).toLocaleString('vi-VN')} ₫</strong>
              </td>
              <td>
