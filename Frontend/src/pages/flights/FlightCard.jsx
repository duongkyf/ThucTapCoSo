...
import "../../style/Pages/FlightCard.css"
...
const FlightCard = ({ flight, onSelect }) => {
  ...
  const hasAI = flight.aiEnabled && flight.explanation !== null;
      ...
      <div className="fc-card">
        ...
        <div className="fc-top">
          ...
          <div className="fc-seats">
            ...
            {/* Nút con mắt AI — chỉ hiện khi có explanation */}
            {hasAI && (
              <button
                onClick={() => setShowAI(true)}
                title="Xem lý do AI gợi ý"
                style={{
                  marginTop:    '8px',
                  background:   '#ede9fe',
